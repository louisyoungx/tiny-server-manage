...
def sendFriendMessage(messaged, userid):
    message.sendFriendMessage(messaged, userid)

def sendGroupMessage(messaged, groupid):
    message.sendGroupMessage(messaged, groupid)
